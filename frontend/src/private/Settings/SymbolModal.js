...
function SymbolModal(props) {
    ...
    return (
        <div className="modal fade" id="modalSymbol" tabIndex="-1" role="dialog" aria-labelledby="modalTitleNotify"
             aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <p className="modal-title" id="modalTitleNotify">Editar Symbol</p>
                        <button ref={btnClose} type="button" className="btn-close" data-bs-dismiss="modal"
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group mb-4">
                                                ...
                                                <div className="input-group">
                                                    <input ref={symbolInput} className="form-control" id="symbol"
                                                           type="text" placeholder="BTCUSD" required disabled/>
                                                    <button type="button"
                                                            className="btn btn-secondary d-inline-flex align-items-center me-2"
                                                            onClick={onFavoriteClick}>
                                                        <svg className="icon icon-xs" fill={getStarFillColor()}
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="basePrecision">Precisão da Base:</label>
                                                <input ref={basePrecisionInput} type="number" className="form-control"
                                                       id="basePrecision" placeholder="8" required/>
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="quotePrecision">Precisão da cotação:</label>
                                                <input ref={quotePrecisionInput} type="number" className="form-control"
                                                       id="quotePrecision" placeholder="8" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input ref={minNotionalInput} type="text" className="form-control"
                                                       id="minNotional" placeholder="0.1" required/>
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="minLotSize">Lote Mínimo:</label>
                                                <input ref={minLotSizeInput} type="text" className="form-control"
                                                       id="minLotSize" placeholder="0.1" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
