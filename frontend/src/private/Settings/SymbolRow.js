        ...
        <tr>
            <td className="text-gray-900">
                ...
                {props.data.isFavorite
                    ? <svg className="icon icon-xs" fill="yellow" stroke="orange" viewBox="0 0 20 20"
            ...
            <td>
                <button id={"edit" + props.data.symbol} className="btn btn-secondary animate-up-2" width={32}
                        onClick={props.onClick} data-bs-toggle="modal" data-bs-target="#modalSymbol">
                    <svg id={"edit" + props.data.symbol} className="icon icon-xs" fill="none" stroke="currentColor"
                         viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  onClick={props.onClick}>
