            ...
            <section className="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
                <div className="container">
                    ...
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxh-500">
                            <div className="text-center">
                                <img src="/img/favicon/mstile-150x150.png" alt="Beholder" width={64}/>
                            </div>
                            <div className="text-center text-md-center mb-4 mt-md-0">
                                <h1 className="mb-0 h3">Entrar na Plataforma</h1>
                            </div>
                                ...
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        <span className="input-group-text" id="basic-addon1">
                                            <svg className="icon icon-xs text-gray-600" fill="currentColor"
                                        ...
                                        <input type="email" className="form-control" placeholder="exemplo@email.com"
                                               id="email" autoFocus required onChange={onChangeInput}/>
                                    </div>
                                </div>
                                    ...
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="password" placeholder="Senha" className="form-control"
                                                   id="password" required onChange={onChangeInput}/>
                                        </div>
                                    </div>
